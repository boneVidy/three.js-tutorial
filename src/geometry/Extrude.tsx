...
import {
    ...
    DirectionalLight, DodecahedronGeometry, DoubleSide, ExtrudeGeometry,
    FrontSide,
    Line,
    LineBasicMaterial,
    Mesh,
    MeshBasicMaterial, MeshLambertMaterial, Shape
} from 'three';
...
function Dodecahedron() {
    useEffect(() => {
        ...
        shape.absarc(0,0,100, Math.PI/2, Math.PI * 1.5, false);
        shape.closePath();
